...
$query = "SELECT pr.*, d.nombre as departamento_nombre,
          ...
          AND pr.fecha_creacion >= DATE_SUB(NOW(), INTERVAL 30 DAY)
...
<head>
    ...
    <title>Productos Nuevos - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="row mb-4">
            <div class="col-md-9">
                <h1><i class="fas fa-star me-2"></i>Productos Nuevos</h1>
                <p class="text-muted">Últimos 30 días - Se encontraron <?php echo $total; ?> productos</p>
            </div>
        </div>
        ...
        <div class="row g-3">
                    ...
                    <div class="product-card">
                        <div class="position-relative">
                            <img src="../uploads/productos/<?php echo htmlspecialchars($producto['imagen_principal'] ?? 'no-image.jpg'); ?>" 
                                 ...
                                 class="product-image">
                            <span class="badge badge-nuevo position-absolute top-0 start-0 m-2">Nuevo</span>
            ...
            <div class="col-12">
                <div class="alert alert-info" role="alert">
                    <i class="fas fa-info-circle me-2"></i> No hay productos nuevos en este momento.
                </div>
            </div>
            <?php endif; ?>
        </div>
